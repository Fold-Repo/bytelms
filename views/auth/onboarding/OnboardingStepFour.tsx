...
const exams = ["English", "Mathematics", "Physics", "CRS",
    "Chemistry", "IRS", "Biology", "Civil Education", "Yoruba", "Futher mathematics",
    "Accounting", "Geography", "Litrature", "Economics", "History", "Agricutural Science"
];
  ...
  return (
    <div className="max-w-xl mx-auto space-y-10">
      ...
      <OnboardingHeader
        ...
        subtitle="What subject would you be taking?"
        description="Select all the subject you would like to practice on. "
      />
